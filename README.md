# Installing Windows on a Samsung Galaxy Book4 Edge
...
- On the device, in the `Samsung Settings` application, on the `About` page, at the very top next to **Model number**.
    ...
    [<img src="./images/driver_pack/SamsungSettingsAboutPage.png" width="50%" />](./images/driver_pack/SamsungSettingsAboutPage.png)
...
- On the device, in the `System Information` application (hit `CTRL+R`, type `msinfo32` and hit enter),  
    ...
    [<img src="./images/driver_pack/SystemInformation.png" width="50%" />](./images/driver_pack/SystemInformation.png)
...
4. Copy the drivers folder `C:\Drivers` to a backup location, this can also be located on an external hard drive or USB flash drive.
</details>
...
4. Start the Windows PE add-on setup (adkwinpesetup.exe) second, and use the default settings.
    ...
    [<img src="./images/windows_adk/PE_Step_1.png" width="40%" />](./images/windows_adk/PE_Step_1.png)
    [<img src="./images/windows_adk/PE_Step_2.png" width="40%" />](./images/windows_adk/PE_Step_2.png)
    [<img src="./images/windows_adk/PE_Step_3.png" width="40%" />](./images/windows_adk/PE_Step_3.png)
    [<img src="./images/windows_adk/PE_Step_4.png" width="40%" />](./images/windows_adk/PE_Step_4.png)
